...
void test(int tag, std::string filepath) {
	...
	Mat img1 = p1.infer_image(filepath);
	//Mat img2 = p2.infer_image(filepath);
	//Mat img3 = p3.infer_image(filepath);
	//Mat img4 = p4.infer_image(filepath);
	//Mat img5 = p5.infer_image(filepath, true);
	//Mat img6 = p6.infer_image(filepath);
	//Mat img7 = p7.infer_image(filepath);
	//imwrite("output.png", img);
}

#include <iostream>
int main(int argc, char *argv[]) {
	std::string filepath = "./input.png";
	if (argc >= 2) {
